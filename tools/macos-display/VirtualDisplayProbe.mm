// Test-only private CoreGraphics API. Never link this helper into DustWave.
...
@interface NSObject (DustWaveVirtualDisplayTest)
...
int main(int argc, char **argv) {
    ...
    @autoreleasepool {
        ...
        [descriptor setValue:@"DustWave virtual display test" forKey:@"name"];
