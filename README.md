...
| `@dustwave/timed-text` | Bounded English/Spanish provider-segment normalization plus deterministic transcript JSON, WebVTT, SRT, and plain-text projections | `0.1.0`; provider calls, storage, review, speaker identity, word alignment, and publication remain consumer-owned |
